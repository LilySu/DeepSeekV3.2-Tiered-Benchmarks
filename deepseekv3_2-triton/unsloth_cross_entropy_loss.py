...
# support for large vocabularies (e.g. DeepSeek-V3's 129280 vocab).
...
# DeepSeek-V3 vocab_size=129280, which exceeds MAX_FUSED_SIZE=65536,
# so the chunked kernel path is used (n_chunks=2: 65536 + 63744).
#
# STATUS: Triton kernel -- production ready.
# The kernel computes log-sum-exp in chunks to handle vocabularies larger
# than what fits in a single Triton block. The backward pass reuses the
# saved logsumexp to avoid recomputation.
#
# Original copyright:
...
def _chunked_cross_entropy_forward(
    ...
    """
    DeepSeek-V3's 129280 vocab divided into chunks of MAX_FUSED_SIZE (65536).
    n_chunks = 2 (65536 + 63744).
...
class Fast_CrossEntropyLoss(torch.autograd.Function):
    ...
    def forward(
        ...
        # For DeepSeek-V3: vocab_size=129280, n_chunks=2
...
def fast_cross_entropy_loss(
    ...
    """
    Triton-accelerated cross-entropy loss for DeepSeek-V3.

    Arguments:
        logits: (batch, seq_len, vocab_size) -- vocab_size=129280 for DeepSeek-V3
