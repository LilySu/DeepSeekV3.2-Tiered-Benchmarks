# Fast SwiGLU -- Triton fused forward + backward kernels.
# Extracted from unsloth/kernels/swiglu.py for standalone use.
#
# Architecture reference: DeepSeek-V3 Technical Report (arXiv 2412.19437)
# SwiGLU is the activation function used in both:
#   - Dense MLP layers (intermediate_size=18432)
#   - MoE expert MLPs (moe_intermediate_size=2048)
#   - Shared expert MLP (moe_intermediate_size * n_shared_experts = 2048)
#
...
import torch
from .unsloth_utils import torch_gpu_device
...
def _fg_kernel(
    ...
    """Forward kernel: h = SiLU(e) * g = (e * sigmoid(e)) * g"""
...
def swiglu_fg_kernel(e, g):
    ...
    For DeepSeek-V3 dense layers: e, g shape [B, S, 18432]
    For DeepSeek-V3 MoE experts: e, g shape [B, S, 2048]
    """
...
def _DWf_DW_dfg_kernel(
    ...
    """
    Backward kernel: computes derivatives for SwiGLU.
...
def swiglu_DWf_DW_dfg_kernel(DW, e, g):
    """SwiGLU backward: compute h, df, de in-place."""
